        ...
        <div className="relative z-10 max-w-md text-center space-y-8">
          <div className="flex justify-center">
            <div className="bg-primary-foreground/15 backdrop-blur-sm p-5 rounded-2xl">
              <Image src="/logo.png" alt="Harbourside Veterinary Clinic" width={80} height={80} />
            </div>
          </div>
          <div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <div className="mb-8 hidden lg:block">
            <Link href="/login" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-4 transition-colors">
